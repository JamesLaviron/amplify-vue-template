  ...
  describe('FORMATIONS constant', () => {
    ...
    it('has correct player counts for each formation', () => {
      FORMATIONS.forEach(formation => {
        const totalPlayers = formation.positions.gk + formation.positions.def + 
                           formation.positions.mid + formation.positions.fwd
  ...
  describe('validateTeamFormation', () => {
    ...
    it('detects too many defenders', () => {
      const selections = [
        ...
        { position: 'DEF' }, { position: 'DEF' }, // 5 defenders instead of 4
    ...
    it('detects too few midfielders', () => {
      const selections = [
        { position: 'GK' },
        { position: 'DEF' }, { position: 'DEF' }, { position: 'DEF' }, { position: 'DEF' },
        { position: 'MID' }, { position: 'MID' }, // Only 2 midfielders instead of 4
