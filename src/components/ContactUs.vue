    ...
    <div class="container mx-auto px-4 max-w-6xl">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-muted-foreground max-w-2xl mx-auto">
          Get in touch with us for any questions, feedback, or business inquiries. We'd love to hear from you!
        </p>
      </div>
            ...
            <CardContent class="space-y-6">
              ...
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:victor@gerfaud.fr" class="text-primary hover:underline cursor-pointer">
                    victor@gerfaud.fr
                  </a>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent class="p-0">
              <div class="w-full h-64 rounded-b-lg overflow-hidden">
                <iframe
                  :src="`https://www.google.com/maps/embed/v1/place?key=${import.meta.env.VITE_GOOGLE_MAPS_API_KEY}&q=60+Avenue+de+Fontainebleau,+Le+Kremlin-Bicêtre,+France&zoom=15`"
                  width="100%"
                  height="100%"
                  style="border:0;"
                  allowfullscreen
              ...
              <div class="p-4 bg-muted/30">
                <p class="text-sm text-muted-foreground">
                  <strong>Note:</strong> This is an approximate location for demonstration purposes. 
                  Please confirm the exact address before visiting.
                </p>
              </div>
            </CardContent>
          </Card>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await fetch(`${(outputs.default as any).custom?.API?.url || ''}/send-email`, {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({
        ...
        priority: 'normal' // Default priority for contact form
      })
    })
    ...
    errorMessage.value = `Failed to send your message: ${error instanceof Error ? error.message : 'Unknown error'}. Please try again or contact us directly at victor@gerfaud.fr`
  } finally {
    loading.value = false
  }
}
